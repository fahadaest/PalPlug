...
const EmployeeDetails = () => {
                ...
                return (
                    <div className="p-4">
                        ...
                        <p className="text-sm text-grey30 mb-4">
                            Employee referral to Slack. Video call required to determine if candidate is a
                            good fit for the position. Once accepted, you will receive a referral confirmation 
                            (You are not guaranteed to receive an offer from Slack).
                        </p>
    ...
    return (
        <>
            <div className={`w-full h-[96px] ${bgColor} flex items-center justify-center`}>
            ...
            <div className="bg-employecard-bg-main-card min-h-screen">
                <div className="flex flex-col lg:flex-row gap-4 p-8 justify-center items-baseline">
                    <div className="flex-1 max-w-[1000px] space-y-4">
                        <EmployeeCard employee={employee} />
                       <div className="bg-white p-4 shadow-lg rounded-md">
                            <h2 className="text-lg font-semibold mb-2 text-text-heading">How it works</h2>
                            <p className="text-sm font-lightbold text-text-heading">
                                If you’re looking to land an amazing job of your dreams at Slack, I’m the person that gives you the best shot. I have been at Slack for 4 years and have built a great reputation in the partnership team and a referral from me will carry huge weight. I’ve gotten 12 people hired through palplug referrrals, resume reviews and interview prep.
                            </p>
                            <p className="text-sm font-lightbold text-text-heading">
                                Even though I would love to get everyone hired, I would need to see your skillset to evaluate if you would be a good candidate for the job to save everyone the time and effort.
                            </p>
                            <p className="text-sm font-semibold text-employecard-card-grey-text">Referrals:</p>
                            <p className="text-sm text-grey40">
                                Once you request a referral, I will reach out to you to schedule a time to hop on a quick video call to review your experience. Please have your resume uploaded or sent to me at idrisgettani@slack.com prior to our call.<br /><br />
                                This isn’t necessarily an interview but a chance to assess if the referral is worth it for you (Don’t want anyone spending $20 if there isn’t really an opportunity to get hired).<br /><br />
                                Once everything looks good, I’ll accept the request and get to work on your referral. After I submit it, I will send you the referral confirmation to finalize the transaction. At that point, I will close the transaction and the money will be transferred.<br /><br />
                                Best of luck!
                            </p>
                        </div>
                    </div>
                        ...
                        <ul className="flex flex-wrap text-sm font-medium text-center text-gray-500 mb-4">
                            {['Referral', 'Resume Review', 'Interview Prep'].map((tab) => (
                                <li key={tab} className="me-2">
                                    <a
                                        href="#"
                                        className={`inline-block px-4 py-3 rounded-lg ${activeTab === tab ? 'bg-blue-600 text-white' : 'hover:text-gray-900 hover:bg-gray-100'}`}
                                        onClick={(e) => {
                                            e.preventDefault();
                                            setActiveTab(tab);
                                        }}
