...
//PhoneAuthProvider is used to initiate phone number authentication and to generate a verification ID that is later used to verify the OTP entered by the user.
