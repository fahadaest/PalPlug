...
const isProfileComplete = personalInfo && professionalInfo && finalStep;
  ...
  return (
    <div className="bg-white flex flex-col lg:flex-row min-h-screen p-5 lg:p-10 gap-8">
      ...
      <div
        className={`bg-white border rounded-lg p-4 md:p-6 w-full lg:w-[853px] pt-6 border-t border-gray-200
        ${resumeData.fileName ? 'h-[650px] lg:h-[450px]' : 'h-auto lg:h-[390px]'}`}
      >
        <div className="pb-5">
        ...
        <div className="space-y-5">
          <div className="flex flex-col md:flex-row items-center md:items-center md:justify-between bg-white h-auto md:h-[76px] rounded-lg shadow-sm border border-gray-200 p-4">
            ...
            {isProfileComplete ? (
              <div className="flex items-center gap-2 mt-4 md:mt-0 md:justify-end">
              ...
              <button
                ...
                className="text-[#005382] font-normal text-[16px] leading-[100%] tracking-[-0.02em] cursor-pointer bg-transparent border-none shadow-none p-0 hover:underline mt-4 md:mt-0 md:justify-end md:text-right"
              >
                Get Started
              </button>
            )}
          ...
          {resumeData.fileName ? (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              <div className="mt-2 ml-0 md:ml-[52px]">
                <div className="flex flex-col items-center md:items-start">
                  <span className="font-medium text-[#005382] break-all w-full max-w-[220px] sm:max-w-none">{resumeData.fileName}</span>
