...
export default function Requirements({
    ...
    const employeeIdParam = employeeId;
    const serviceParam = service;
    const selectedPackagesParam = selectedPackages;
    const totalPriceParam = totalPrice;
    const serviceFeeParam = serviceFee;
    const totalDeliveryDaysParam = totalDeliveryDays;
                    ...
                    <div className="flex gap-8 mt-8">
                        <div className="flex-1">
                            ...
                            <p className="font-poppins text-[14px] font-semibold leading-[150%] tracking-[0%] align-middle mb-6">
                                {data.displayName.split(' ')[0]} is requesting
                                the following items to review before your
                                scheduled call
                            </p>
