 ...
 const handleFinish = (event) => {
  ...
  return (
    ...
    {!isServicesSelectionVisible ? (
      <form className="p-20" onSubmit={currentStep === 3 ? handleFinish : handleContinue}>
        {currentStep === 1 && (
          <div>
            <div className=" w-auto md:w-[698px] mb-4">
            ...
            <div className="flex flex-col md:flex-row md:w-[703px]  justify-between pt-4">
              ...
              <div className="w-auto max-w-[355px]   flex flex-col  gap-[8px]">
