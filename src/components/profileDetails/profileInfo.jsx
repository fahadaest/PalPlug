 ...
 const handleFinish = (event) => {
  ...
  return (
    ...
    {!isServicesSelectionVisible ? (
     <form
     className="pl-[16px] pr-[16px] md:p-20"
     onSubmit={currentStep === 3 ? handleFinish : handleContinue}
   >
     {currentStep === 1 && (
       <div className="flex flex-col gap-[24px]">
         <div className="w-auto md:w-[698px] flex gap-[24px] flex-col">
         ...
         <div className="flex flex-col gap-[24px] md:flex-row md:w-[703px] ">
         ...
         <div className="w-auto md:w-[703px] flex flex-col gap-[8px]">
           ...
           <textarea
             ...
             className="border rounded-[8px] h-[147px] p-3 text-[16px] font-lightbold placeholder-[#939393] focus:border-[#005382] focus:outline-none"
         ...
         <button
           ...
           className={`h-[40px] w-auto max-w-[358px] md:w-[175px] p-[11px_20px_11px_20px] ${
             isFormValid
               ? 'bg-[#005580] cursor-pointer'
               : 'bg-[#CCDDE6] cursor-not-allowed'
          ...
          <div className="flex flex-col gap-[24px]">
            <div className="flex flex-col gap-[16px]">
              ...
              <div className="flex justify-between items-center">
                ...
                <img src={EmailIcon.src} alt="Email" className="h-[24px] w-[24px]" />
              ...
              <div className="flex flex-nowrap flex-row gap-[16px]">
              <img src={PhoneIcon.src} alt="Phone" className="h-[24px] w-[24px]" />
              <span className="text-[14px] font-normal text-[#000000]">Number</span>
                  <span className="text-[14px] italic font-normal text-[#555555]">Private</span>
                  </div>
              {isVerificationComplete ? (
